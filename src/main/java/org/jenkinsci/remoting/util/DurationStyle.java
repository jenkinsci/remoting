 ...
 * Copied from the <a href="https://github.com/spring-projects/spring-boot/blob/8b8e263835206d50200abf1aced10be62c6fbfb7/spring-boot-project/spring-boot/src/main/java/org/springframework/boot/convert/DurationStyle.java">Spring Boot</a> project.
 *
 *
 * @author Phillip Webb
 * @author Valentine Wu
    ...
    SIMPLE("^([+-]?\\d+)([a-zA-Z]{0,2})$") {
        ...
        public Duration parse(String value, ChronoUnit unit) {
            try {
                ...
                if (!matcher.matches()) {
                    throw new IllegalStateException("Does not match simple duration pattern");
                }
