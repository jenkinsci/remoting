...
public class InetAddressValidatorTest extends TestCase {
    ...
    public void testIPv6() {
        ...
        assertTrue(
                "IPV6 ::1 should be valid", validator.isValidInet6Address("::1")); // loopback, compressed, non-routable
        assertTrue(
        ...
        assertTrue(
                "IPV6 FF01::101 should be valid", validator.isValidInet6Address("FF01::101")); // multicast, compressed
        assertFalse(
        ...
        assertFalse(
                ...
                validator.isValidInet6Address("02001:0000:1234:0000:0000:C1C0:ABCD:0876")); // extra 0 not allowed!
        assertFalse(
                "IPV6 2001:0000:1234:0000:00001:C1C0:ABCD:0876 should be invalid",
                validator.isValidInet6Address("2001:0000:1234:0000:00001:C1C0:ABCD:0876")); // extra 0 not allowed!
        assertFalse(
                "IPV6 2001:0000:1234:0000:0000:C1C0:ABCD:0876 0 should be invalid",
                validator.isValidInet6Address("2001:0000:1234:0000:0000:C1C0:ABCD:0876 0")); // junk after valid address
        assertFalse(
                "IPV6 2001:0000:1234: 0000:0000:C1C0:ABCD:0876 should be invalid",
                validator.isValidInet6Address("2001:0000:1234: 0000:0000:C1C0:ABCD:0876")); // internal space
        assertFalse(
                "IPV6 3ffe:0b00:0000:0001:0000:0000:000a should be invalid",
                validator.isValidInet6Address("3ffe:0b00:0000:0001:0000:0000:000a")); // seven segments
        assertFalse(
                "IPV6 FF02:0000:0000:0000:0000:0000:0000:0000:0001 should be invalid",
                validator.isValidInet6Address("FF02:0000:0000:0000:0000:0000:0000:0000:0001")); // nine segments
        assertFalse(
        ...
        assertFalse(
                "IPV6 1::5:300.300.300.300 should be invalid", validator.isValidInet6Address("1::5:300.300.300.300"));
        ...
        assertFalse(
                ...
                validator.isValidInet6Address("2001:1:1:1:1:1:255Z255X255Y255")); // garbage instead of "." in IPv4
        assertFalse(
        ...
        assertTrue(
                ...
                validator.isValidInet6Address("0:0:0:0:0:FFFF:129.144.52.38")); // IPv4-mapped IPv6 address, full
        assertTrue(
                "IPV6 ::13.1.68.3 should be valid",
                validator.isValidInet6Address("::13.1.68.3")); // IPv4-compatible IPv6 address, compressed, deprecated
        assertTrue(
                "IPV6 ::FFFF:129.144.52.38 should be valid",
                validator.isValidInet6Address("::FFFF:129.144.52.38")); // IPv4-mapped IPv6 address, compressed
        assertTrue(
        ...
        assertTrue(
                ...
                validator.isValidInet6Address("::ffff:192.0.2.128")); // but this is OK, since there's a single digit
        assertFalse(
        ...
        assertFalse(
                "IPV6 1111:2222:3333::5555: should be invalid", validator.isValidInet6Address("1111:2222:3333::5555:"));
        ...
        assertTrue(
                ...
                validator.isValidInet6Address("1111:2222:3333:4444:5555::"));
        assertTrue(
                "IPV6 1111:2222:3333:4444:: should be valid", validator.isValidInet6Address("1111:2222:3333:4444::"));
        ...
        assertTrue(
                "IPV6 ::5555:6666:7777:8888 should be valid", validator.isValidInet6Address("::5555:6666:7777:8888"));
        assertTrue(
        ...
        assertTrue(
                "IPV6 1111::123.123.123.123 should be valid", validator.isValidInet6Address("1111::123.123.123.123"));
        ...
        assertTrue(
                "IPV6 ::6666:123.123.123.123 should be valid", validator.isValidInet6Address("::6666:123.123.123.123"));
        assertTrue(
        ...
        assertFalse(
                ...
                validator.isValidInet6Address("1111:2222:3333:4444:5555:"));
        assertFalse(
                "IPV6 1111:2222:3333:4444: should be invalid", validator.isValidInet6Address("1111:2222:3333:4444:"));
        assertFalse("IPV6 1111:2222:3333: should be invalid", validator.isValidInet6Address("1111:2222:3333:"));
        assertFalse("IPV6 1111:2222: should be invalid", validator.isValidInet6Address("1111:2222:"));
        ...
        assertFalse(
                "IPV6 :5555:6666:7777:8888 should be invalid", validator.isValidInet6Address(":5555:6666:7777:8888"));
        assertFalse(
        ...
        assertFalse(
                ...
                validator.isValidInet6Address(":1111:2222:3333:4444::8888"));
        assertFalse(
                "IPV6 :1111:2222:3333::8888 should be invalid", validator.isValidInet6Address(":1111:2222:3333::8888"));
        ...
        assertFalse(
                ...
                validator.isValidInet6Address(":1111:2222:3333::7777:8888"));
        assertFalse(
                "IPV6 :1111:2222::7777:8888 should be invalid", validator.isValidInet6Address(":1111:2222::7777:8888"));
        ...
        assertFalse(
                ...
                validator.isValidInet6Address(":1111:2222::6666:7777:8888"));
        assertFalse(
                "IPV6 :1111::6666:7777:8888 should be invalid", validator.isValidInet6Address(":1111::6666:7777:8888"));
        assertFalse("IPV6 :::6666:7777:8888 should be invalid", validator.isValidInet6Address(":::6666:7777:8888"));
        assertFalse(
                "IPV6 :1111:2222:3333::5555:6666:7777:8888 should be invalid",
                validator.isValidInet6Address(":1111:2222:3333::5555:6666:7777:8888"));
        ...
        assertFalse(
                "IPV6 :::5555:6666:1.2.3.4 should be invalid", validator.isValidInet6Address(":::5555:6666:1.2.3.4"));
        assertFalse(
                "IPV6 :1111:2222::4444:5555:6666:1.2.3.4 should be invalid",
                validator.isValidInet6Address(":1111:2222::4444:5555:6666:1.2.3.4"));
        assertFalse(
